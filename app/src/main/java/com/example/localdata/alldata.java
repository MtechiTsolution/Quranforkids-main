...
public class alldata {
    ...
    new Dua_model("سیڑھیاں چڑھتے وقت کی دعا","14","سیڑھیاں چڑھتے وقت", "اَللّٰهُ اَكْبَر ُ","Allah Almighty is the greatest.","اللہ سب سے بڑا ہے", R.drawable.upstairs,Color.WHITE),
