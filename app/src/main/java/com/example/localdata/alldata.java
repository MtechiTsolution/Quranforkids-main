...
public class alldata {
    ...
    new Dua_model("کھانے کے بعد کی دعا","3","کھانے کے بعد", "الْحَمْدُ لِلَّهِ الَّذِي أَطْعَمَنَا وَسَقَانَا وَجَعَلَنَا مِنَ الْمُسْلِمِين","Thanks to Allah Azzawajal who fed us and made us among Muslims.","اللہ عزوجل کا شکر ہے جس نے ہمیں کھلایا پلایا اور مسلمانوں میں سے بنایا۔", R.drawable.after_eat,Color.WHITE),
    ...
    new Dua_model("مصافحہ کرتے وقت کی دعا","6","ہاتھ ملاتے وقت", "یَغْفِرُاللّٰہُ لَنَا وَلَکُمْ۔","May Allah Almighty forgive us and you.","اللہ عزوجل تمہاری اور ہماری مغفرت فرمائے۔", R.drawable.handshake,Color.WHITE),
